...
table_schema:db1              engine:InnoDB                         engine_counts:              1 
...
Innodb_buffer_pool_pages_data : 571
Innodb_buffer_pool_pages_flushed : 3986
Innodb_buffer_pool_read_requests : 902605
Innodb_buffer_pool_read_ahead : 0
Innodb_buffer_pool_read_ahead_evicted : 0
Innodb_buffer_pool_reads : 514
Innodb_buffer_pool_pages_free : 523648
Innodb_buffer_pool_wait_free : 0
脏页在缓冲池数据页中的占比为: 0.0%
InnoDB buffer pool 命中率: 99.94%
4.2 并发线程连接数:
Threads_connected : 4
Threads_created : 18
Threads_running : 1
...
Innodb_row_lock_time : 244054
Innodb_row_lock_time_avg : 61013
Innodb_row_lock_time_max : 61015
...
Created_tmp_tables : 34096
Created_tmp_disk_tables : 14216
4.6 InnoDB关键特性double write的使用情况:
Innodb_dblwr_pages_written : 182
...
db_name:terrace_db           tmp_tables:784 tmp_disk_tables:784 tmp_all:1568 last_seen:2019-08-28 23:18:54 query_sql:SHOW FULL TABLES 
db_name:db1                  tmp_tables:116 tmp_disk_tables:116 tmp_all:232 last_seen:2019-08-28 18:23:30 query_sql:SHOW STATUS 
db_name:db1                  tmp_tables:76 tmp_disk_tables:38 tmp_all:114 last_seen:2019-08-28 18:23:30 query_sql:SELECT `QUERY_ID` , SUM ( `DUR ... ROFILING` GROUP BY `QUERY_ID` 
db_name:db1                  tmp_tables:76 tmp_disk_tables:38 tmp_all:114 last_seen:2019-08-28 18:23:30 query_sql:SELECT `STATE` AS `状态` , `ROUN ... OUP BY `STATE` ORDER BY `SEQ` 
db_name:terrace_db           tmp_tables:21 tmp_disk_tables:21 tmp_all:42 last_seen:2019-08-27 04:53:25 query_sql:SHOW STATUS 
