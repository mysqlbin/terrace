...
Innodb_buffer_pool_pages_flushed : 1611
Innodb_buffer_pool_read_requests : 89633
Innodb_buffer_pool_read_ahead : 0
Innodb_buffer_pool_read_ahead_evicted : 0
Innodb_buffer_pool_reads : 513
Innodb_buffer_pool_pages_free : 523684
Innodb_buffer_pool_wait_free : 0
脏页在缓冲池数据页中的占比为: 0.0%
InnoDB buffer pool 命中率: 99.42999999999999%
4.2 并发线程连接数:
Threads_connected : 3
Threads_created : 24
Threads_running : 1
...
Created_tmp_tables : 3503
Created_tmp_disk_tables : 1511
...
db_name:terrace_db           tmp_tables:292 tmp_disk_tables:292 tmp_all:584 last_seen:2019-09-02 09:03:56 query_sql:SHOW FULL TABLES 
db_name:terrace_db           tmp_tables:60 tmp_disk_tables:60 tmp_all:120 last_seen:2019-09-02 04:09:52 query_sql:SELECT `mysql_slow_query_revie ... _slow_query_review_history` . 
db_name:terrace_db           tmp_tables:34 tmp_disk_tables:34 tmp_all:68 last_seen:2019-09-02 04:09:52 query_sql:SELECT COUNT ( * ) FROM ( SELE ... ory` . `hostname_max` = ? AND 
db_name:terrace_db           tmp_tables:21 tmp_disk_tables:21 tmp_all:42 last_seen:2019-09-02 02:30:57 query_sql:SHOW STATUS 
db_name:information_schema   tmp_tables:41 tmp_disk_tables:0 tmp_all:41 last_seen:2019-09-02 04:09:51 query_sql:SHOW SCHEMAS 
db_name:terrace_db           tmp_tables:12 tmp_disk_tables:12 tmp_all:24 last_seen:2019-09-02 03:50:05 query_sql:SELECT COUNT ( * ) FROM ( SELE ... query_review_history` WHERE ( 
