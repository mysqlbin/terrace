...
1.5 自增ID占比大于 1.0% 的表 :
   table_schema:niuniu_db       table_name:table_clubgamescoredetail_history        auto_increment_ratio:0.0169 max_value:2147483647 auto_increment:36376871
   table_schema:niuniu_db       table_name:table_clublogscore_history               auto_increment_ratio:0.0145 max_value:2147483647 auto_increment:31057492
1.6 碎片大于多少 0.5G 的表 :
   ###没有碎片大于多少 0.5G 的表###
1.7 统计大字段表:
...
4.5 创建内存临时表和磁盘临时表的次数:
   Created_tmp_disk_tables : 8181
   Created_tmp_tables : 33167
4.6 InnoDB关键特性double write的使用情况:
   Innodb_dblwr_pages_written : 208915
   Innodb_dblwr_writes : 46728
   每次写操作合并page的个数: 4.0
