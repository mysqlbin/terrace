...
1.3 数据量排名前靠前的大表:
   ...
   table_schema:terrace_db       table_name:myapp_oper_log                           all_size:0.05M           data_size:0.02M           index_size:0.03M           table_rows:    0
   table_schema:terrace_db       table_name:auth_group_permissions                   all_size:0.05M           data_size:0.02M           index_size:0.03M           table_rows:    0
   table_schema:terrace_db       table_name:myapp_db_name                            all_size:0.05M           data_size:0.02M           index_size:0.03M           table_rows:    7
...
4.5 创建内存临时表和磁盘临时表的次数:
   Created_tmp_disk_tables : 810
   Created_tmp_tables : 7502
