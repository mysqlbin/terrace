...
Innodb_buffer_pool_pages_data : 562
Innodb_buffer_pool_pages_flushed : 983
Innodb_buffer_pool_read_requests : 39528
Innodb_buffer_pool_read_ahead : 0
Innodb_buffer_pool_read_ahead_evicted : 0
Innodb_buffer_pool_reads : 510
Innodb_buffer_pool_pages_free : 523689
Innodb_buffer_pool_wait_free : 0
脏页在缓冲池数据页中的占比为: 0.0%
InnoDB buffer pool 命中率: 98.74000000000001%
4.2 并发线程连接数:
Threads_connected : 7
Threads_created : 24
Threads_running : 1
...
Created_tmp_tables : 1328
Created_tmp_disk_tables : 625
4.6 InnoDB关键特性double write的使用情况:
Innodb_dblwr_pages_written : 130
Innodb_dblwr_writes : 50
每次写操作合并page的个数: 3.0
4.7 因log buffer不足导致等待的次数:
Innodb_log_waits : 0
5. 其它巡检项:
5.1 使用到内存临时表或者磁盘临时表的前 20 个SQL:
db_name:terrace_db           tmp_tables:160 tmp_disk_tables:160 tmp_all:320 last_seen:2019-08-30 08:31:22 query_sql:SHOW FULL TABLES 
db_name:terrace_db           tmp_tables:35 tmp_disk_tables:35 tmp_all:70 last_seen:2019-08-30 08:21:44 query_sql:SELECT `mysql_slow_query_revie ... _slow_query_review_history` . 
db_name:terrace_db           tmp_tables:16 tmp_disk_tables:16 tmp_all:32 last_seen:2019-08-30 08:24:11 query_sql:SHOW STATUS 
db_name:information_schema   tmp_tables:24 tmp_disk_tables:0 tmp_all:24 last_seen:2019-08-30 06:36:30 query_sql:SHOW SCHEMAS 
...
db_name:terrace_db           tmp_tables:8 tmp_disk_tables:4 tmp_all:12 last_seen:2019-08-30 08:17:27 query_sql:SELECT `QUERY_ID` , SUM ( `DUR ... ROFILING` GROUP BY `QUERY_ID` 
db_name:terrace_db           tmp_tables:8 tmp_disk_tables:4 tmp_all:12 last_seen:2019-08-30 08:17:27 query_sql:SELECT `STATE` AS `状态` , `ROUN ... OUP BY `STATE` ORDER BY `SEQ` 
db_name:db1                  tmp_tables:4 tmp_disk_tables:4 tmp_all:8 last_seen:2019-08-30 03:52:31 query_sql:SHOW FIELDS FROM `db1` . `accountinfo` 
db_name:db1                  tmp_tables:7 tmp_disk_tables:0 tmp_all:7 last_seen:2019-08-30 06:37:25 query_sql:SHOW TABLES 
db_name:terrace_db           tmp_tables:7 tmp_disk_tables:0 tmp_all:7 last_seen:2019-08-30 08:28:05 query_sql:SHOW TABLE STATUS LIKE ? 
db_name:terrace_db           tmp_tables:7 tmp_disk_tables:0 tmp_all:7 last_seen:2019-08-30 08:28:05 query_sql:SHOW ENGINES 
db_name:terrace_db           tmp_tables:3 tmp_disk_tables:3 tmp_all:6 last_seen:2019-08-30 06:09:56 query_sql:SHOW TABLES 
