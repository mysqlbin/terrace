...
Innodb_buffer_pool_pages_flushed : 645
Innodb_buffer_pool_read_requests : 21218
Innodb_buffer_pool_read_ahead : 0
Innodb_buffer_pool_read_ahead_evicted : 0
Innodb_buffer_pool_reads : 498
Innodb_buffer_pool_pages_free : 523702
Innodb_buffer_pool_wait_free : 0
脏页在缓冲池数据页中的占比为: 0.0%
InnoDB buffer pool 命中率: 97.74000000000001%
4.2 并发线程连接数:
Threads_connected : 5
Threads_created : 24
Threads_running : 2
...
db_name:terrace_db           tmp_tables:129 tmp_disk_tables:129 tmp_all:258 last_seen:2019-08-30 07:20:39 query_sql:SHOW FULL TABLES 
...
db_name:terrace_db           tmp_tables:8 tmp_disk_tables:8 tmp_all:16 last_seen:2019-08-30 04:10:49 query_sql:SHOW FIELDS FROM `terrace_db` . `myapp_db_instance` 
db_name:terrace_db           tmp_tables:8 tmp_disk_tables:8 tmp_all:16 last_seen:2019-08-30 07:20:10 query_sql:SELECT `mysql_slow_query_revie ... _slow_query_review_history` . 
...
db_name:db1                  tmp_tables:3 tmp_disk_tables:3 tmp_all:6 last_seen:2019-08-30 03:52:19 query_sql:SHOW STATUS 
db_name:terrace_db           tmp_tables:3 tmp_disk_tables:3 tmp_all:6 last_seen:2019-08-30 04:10:49 query_sql:SHOW STATUS 
db_name:terrace_db           tmp_tables:2 tmp_disk_tables:2 tmp_all:4 last_seen:2019-08-30 02:28:16 query_sql:SHOW FULL TABLES WHERE `Table_type` != ? 
db_name:terrace_db           tmp_tables:2 tmp_disk_tables:2 tmp_all:4 last_seen:2019-08-30 02:28:16 query_sql:SHOW TABLE STATUS 
db_name:terrace_db           tmp_tables:4 tmp_disk_tables:0 tmp_all:4 last_seen:2019-08-30 04:09:14 query_sql:SHOW TABLE STATUS LIKE ? 
