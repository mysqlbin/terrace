...
4.4 打开表的次数:
   Open_files : 4
   Open_tables : 1024
   Opened_tables : 101129
4.5 创建内存临时表和磁盘临时表的次数:
   Created_tmp_disk_tables : 8504
   Created_tmp_tables : 35374
4.6 InnoDB关键特性double write的使用情况:
   Innodb_dblwr_pages_written : 208921
   Innodb_dblwr_writes : 46734
   每次写操作合并page的个数: 4.0
