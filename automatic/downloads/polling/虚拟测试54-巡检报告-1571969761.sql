...
1.6 碎片大于多少 0.0001G 的表 :
     ...
     table_schema:test_db          table_name:t2                                       fragment:19.00M    
...
4.5 创建内存临时表和磁盘临时表的次数:
   Created_tmp_disk_tables : 8071
   Created_tmp_tables : 32429
4.6 InnoDB关键特性double write的使用情况:
   Innodb_dblwr_pages_written : 208913
   Innodb_dblwr_writes : 46726
   每次写操作合并page的个数: 4.0
