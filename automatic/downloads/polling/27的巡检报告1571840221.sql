4. 状态巡检项:
4.1 InnoDB层缓冲池状态:
脏页在缓冲池数据页中的占比为: 100.0%
   Innodb_buffer_pool_pages_data : 549
脏页在缓冲池数据页中的占比为: 1100.0%
   Innodb_buffer_pool_pages_dirty : 11
脏页在缓冲池数据页中的占比为: 1100.0%
   Innodb_buffer_pool_pages_flushed : 151
脏页在缓冲池数据页中的占比为: 1100.0%
...
脏页在缓冲池数据页中的占比为: 0.16999999999999998%
   Innodb_buffer_pool_read_requests : 16190
脏页在缓冲池数据页中的占比为: 0.16999999999999998%
...
1.3 数据量排名前靠前的大表:
   ...
   table_schema:zst              table_name:t2019100702                              all_size:0.05M           data_size:0.02M           index_size:0.03M           table_rows:    2
   table_schema:terrace_db       table_name:auth_user_user_permissions               all_size:0.05M           data_size:0.02M           index_size:0.03M           table_rows:    0
