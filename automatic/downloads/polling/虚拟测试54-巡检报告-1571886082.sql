...
4.5 创建内存临时表和磁盘临时表的次数:
   Created_tmp_disk_tables : 7286
   Created_tmp_tables : 29339
4.6 InnoDB关键特性double write的使用情况:
   Innodb_dblwr_pages_written : 208230
   Innodb_dblwr_writes : 46565
   每次写操作合并page的个数: 4.0
