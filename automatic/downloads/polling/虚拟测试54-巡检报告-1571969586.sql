...
1.5 自增ID占比大于 5555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555% 的表 :
   ###没有自增ID占比大于 5555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555555% 的表###
1.6 碎片大于多少 0.5G 的表 :
    ###没有碎片大于多少 0.5G 的表###
1.7 统计大字段表:
...
4.5 创建内存临时表和磁盘临时表的次数:
   Created_tmp_disk_tables : 7962
   Created_tmp_tables : 31692
4.6 InnoDB关键特性double write的使用情况:
   Innodb_dblwr_pages_written : 208911
   Innodb_dblwr_writes : 46724
   每次写操作合并page的个数: 4.0
