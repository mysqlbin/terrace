...
2.索引巡检项:
2.1 获取索引数目大于 3 个的表:
   table_schema: db1              table_name: t_detail                                 index_name: idx_nClubID_bRobot_tEndTime_nPlayerID column_name: nClubID 
   table_schema: db1              table_name: t_detail                                 index_name: idx_nClubID_bRobot_tEndTime_nPlayerID column_name: bRobot 
   table_schema: db1              table_name: t_detail                                 index_name: idx_nClubID_bRobot_tEndTime_nPlayerID column_name: tEndTime 
   table_schema: db1              table_name: t_detail                                 index_name: idx_nClubID_bRobot_tEndTime_nPlayerID column_name: nPlayerID 
   table_schema: db1              table_name: table_clubgamescoredetail                index_name: idx_tEndTime_bRobot  column_name: tEndTime 
   table_schema: db1              table_name: table_clubgamescoredetail                index_name: idx_tEndTime_bRobot  column_name: bRobot 
   table_schema: db1              table_name: table_clubgamescoredetail                index_name: idx_nPlayerID_nGameType_bRobot_tEndTime column_name: nPlayerID 
   table_schema: db1              table_name: table_clubgamescoredetail                index_name: idx_nPlayerID_nGameType_bRobot_tEndTime column_name: nGameType 
   table_schema: db1              table_name: table_clubgamescoredetail                index_name: idx_nPlayerID_nGameType_bRobot_tEndTime column_name: bRobot 
   table_schema: db1              table_name: table_clubgamescoredetail                index_name: idx_nPlayerID_nGameType_bRobot_tEndTime column_name: tEndTime 
   table_schema: mydjango_db      table_name: auth_group_permissions                   index_name: auth_group_permissions_group_id_permission_id_0cd325b0_uniq column_name: group_id 
   table_schema: mydjango_db      table_name: auth_group_permissions                   index_name: auth_group_permissions_group_id_permission_id_0cd325b0_uniq column_name: permission_id 
   table_schema: mydjango_db      table_name: auth_permission                          index_name: auth_permission_content_type_id_codename_01ab375a_uniq column_name: content_type_id 
   table_schema: mydjango_db      table_name: auth_permission                          index_name: auth_permission_content_type_id_codename_01ab375a_uniq column_name: codename 
   table_schema: mydjango_db      table_name: auth_user_groups                         index_name: auth_user_groups_user_id_group_id_94350c0c_uniq column_name: user_id 
   table_schema: mydjango_db      table_name: auth_user_groups                         index_name: auth_user_groups_user_id_group_id_94350c0c_uniq column_name: group_id 
   table_schema: mydjango_db      table_name: auth_user_user_permissions               index_name: auth_user_user_permissions_user_id_permission_id_14a6b632_uniq column_name: user_id 
   table_schema: mydjango_db      table_name: auth_user_user_permissions               index_name: auth_user_user_permissions_user_id_permission_id_14a6b632_uniq column_name: permission_id 
   table_schema: mydjango_db      table_name: django_content_type                      index_name: django_content_type_app_label_model_76bd3d3b_uniq column_name: app_label 
   table_schema: mydjango_db      table_name: django_content_type                      index_name: django_content_type_app_label_model_76bd3d3b_uniq column_name: model 
   table_schema: niuniu_db        table_name: table_clubgamescoredetail                index_name: idx_nClubID_nTableID_nPlayerID_tStartTime column_name: nClubID 
   table_schema: niuniu_db        table_name: table_clubgamescoredetail                index_name: idx_nClubID_nTableID_nPlayerID_tStartTime column_name: nTableID 
   table_schema: niuniu_db        table_name: table_clubgamescoredetail                index_name: idx_nClubID_nTableID_nPlayerID_tStartTime column_name: nPlayerID 
   table_schema: niuniu_db        table_name: table_clubgamescoredetail                index_name: idx_nClubID_nTableID_nPlayerID_tStartTime column_name: tStartTime 
   table_schema: niuniu_db        table_name: table_clublogplatformscore               index_name: idx_nClubID_nGameID_nType_CreateTime column_name: nClubID 
   table_schema: niuniu_db        table_name: table_clublogplatformscore               index_name: idx_nClubID_nGameID_nType_CreateTime column_name: nGameID 
   table_schema: niuniu_db        table_name: table_clublogplatformscore               index_name: idx_nClubID_nGameID_nType_CreateTime column_name: nType 
   table_schema: niuniu_db        table_name: table_clublogplatformscore               index_name: idx_nClubID_nGameID_nType_CreateTime column_name: CreateTime 
   table_schema: niuniu_db        table_name: table_clublogscore                       index_name: idx_nGameID_clubid_nType_CreateTime column_name: nGameID 
   table_schema: niuniu_db        table_name: table_clublogscore                       index_name: idx_nGameID_clubid_nType_CreateTime column_name: clubid 
   table_schema: niuniu_db        table_name: table_clublogscore                       index_name: idx_nGameID_clubid_nType_CreateTime column_name: nType 
   table_schema: niuniu_db        table_name: table_clublogscore                       index_name: idx_nGameID_clubid_nType_CreateTime column_name: CreateTime 
   table_schema: terrace_db       table_name: auth_group_permissions                   index_name: auth_group_permissions_group_id_permission_id_0cd325b0_uniq column_name: group_id 
   table_schema: terrace_db       table_name: auth_group_permissions                   index_name: auth_group_permissions_group_id_permission_id_0cd325b0_uniq column_name: permission_id 
   table_schema: terrace_db       table_name: auth_permission                          index_name: auth_permission_content_type_id_codename_01ab375a_uniq column_name: content_type_id 
   table_schema: terrace_db       table_name: auth_permission                          index_name: auth_permission_content_type_id_codename_01ab375a_uniq column_name: codename 
   table_schema: terrace_db       table_name: auth_user_groups                         index_name: auth_user_groups_user_id_group_id_94350c0c_uniq column_name: user_id 
   table_schema: terrace_db       table_name: auth_user_groups                         index_name: auth_user_groups_user_id_group_id_94350c0c_uniq column_name: group_id 
   table_schema: terrace_db       table_name: auth_user_user_permissions               index_name: auth_user_user_permissions_user_id_permission_id_14a6b632_uniq column_name: user_id 
   table_schema: terrace_db       table_name: auth_user_user_permissions               index_name: auth_user_user_permissions_user_id_permission_id_14a6b632_uniq column_name: permission_id 
   table_schema: terrace_db       table_name: django_content_type                      index_name: django_content_type_app_label_model_76bd3d3b_uniq column_name: app_label 
   table_schema: terrace_db       table_name: django_content_type                      index_name: django_content_type_app_label_model_76bd3d3b_uniq column_name: model 
   table_schema: test_db          table_name: table_clubgamescoredetail                index_name: idx_tEndTime_bRobot  column_name: tEndTime 
   table_schema: test_db          table_name: table_clubgamescoredetail                index_name: idx_tEndTime_bRobot  column_name: bRobot 
2.2 获取没有主键索引的表:
   ###没有主键索引的表###
3.参数巡检项:
3.1 InnoDB层参数:
