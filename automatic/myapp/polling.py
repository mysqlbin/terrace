...
def download_polling_report(request):
    ...
    try:
        ...
        # innodb_create_tmp_table_status = query_engine.get_status(innodb_create_tmp_table_status)
        # innodb_double_write_status = query_engine.get_status(innodb_double_write_status)
