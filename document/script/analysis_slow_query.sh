...
#create  database archery DEFAULT CHARSET utf8mb4 -- UTF-8 Unicode COLLATE utf8mb4_general_ci;

#配置archery数据库的连接地址
monitor_db_host="192.168.0.54"
monitor_db_port=3306
monitor_db_user="root"
monitor_db_password="123456abc"
monitor_db_database="archery"

#实例慢日志位置
slowquery_file="/data/mysql/mysql3306/slow.log"
pt_query_digest="/usr/bin/pt-query-digest"

#实例连接信息
hostname="192.168.0.54:3306" # 和archery实例配置内容保持一致，用于archery做筛选
